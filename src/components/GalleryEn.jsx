...
const timelineSessions = [
  { name: 'Andras Dori', dir: '1. Andras Dori' },
  { name: 'Antonella Csongor', dir: '2. Antonella Csongor' },
  { name: 'Bocsi Barbi', dir: '3. Bocsi Barbi' },
  { name: 'Fashion Show', dir: '4. Divatbemutato' },
  { name: 'Kalman 2023', dir: '5. Kalman 2023' },
  { name: 'Christmas Tango Ball', dir: '6. Karacsonyi tangobal' },
  { name: 'Moni 1', dir: '7. Moni 1' },
  { name: 'Moni 2', dir: '8. Moni 2' },
  { name: 'Tango Ball 2018', dir: '9. Tangobal 2018' },
  { name: 'Tango Ball 2019', dir: '10. Tangobal 2019' },
];
  ...
  return (
    <main className="d-flex flex-column min-vh-100 bg-black text-light justify-content-center align-items-center pt-5">
      <div className="container py-5">
        <h1 className="display-5 fw-bold mb-4 text-center">Gallery</h1>
